...
st.set_page_config(page_title="Terms and Conditions Analyser", page_icon="📄", layout="wide")
...
st.markdown(
    ...
    .stTextInput input {
        ...
        min-height: 3.2rem;
        caret-color: #0b1f3a !important; /* Visible cursor */
    }
    .stTextInput input:focus {
        border: 2px solid #0b1f3a !important;
        box-shadow: 0 0 0 4px rgba(11, 31, 58, 0.08) !important;
    }
    ...
    /* Remove custom uploader styling that caused glitch */
    .workspace-empty {
    ...
    <div class="hero-card">
        <div class="hero-layout">
            <div>
                ...
                <div class="hero-title">Terms and Conditions Analyser</div>
...
st.markdown(
    ...
    <div class="input-stage">
        ...
        <div class="section-intro">Analyze first, understand the risks, then ask direct questions only if you need clarification.</div>
    </div>
    """,
    unsafe_allow_html=True,
)
...
if st.session_state.analysis_payload:
    ...
    with result_tab_overview:
        ...
        with overview_header_col:
            pass # Removed unnecessary headers as requested.
    ...
    with result_tab_chat:
        ...
        question = st.text_input("Ask something about the document", key="document_question", placeholder="Typing here shows the cursor clearly...")
...
# Workspace utility shifted back to sidebar.
